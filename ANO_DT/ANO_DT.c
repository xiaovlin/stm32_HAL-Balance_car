...
void ANO_DT_Send_Data(uint8_t *dataToSend, uint32_t length)
{
	for (uint8_t i = 0; i < length; i++)
	{
		usart1_send_char(dataToSend[i]);
	}
}


//void uart_putbuff(int16_t* data, uint32_t len)
//{
...
//	
//	int16_t cmdf[2] = {CMD_WARE, ~CMD_WARE};
//	int16_t cmdr[2] = {~CMD_WARE, CMD_WARE};
//	
//	uart_putbuff(cmdf, sizeof(cmdf));
//	uart_putbuff(wareaddr, waresize);
//	uart_putbuff(cmdr, sizeof(cmdf));
//}
